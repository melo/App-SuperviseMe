# This Makefile is for the App::SuperviseMe extension to perl.
#
...
#     ABSTRACT => q[very simple command superviser]
#     AUTHOR => [q[Pedro Melo <melo@simplicidade.org>]]
#     BUILD_REQUIRES => { Test::More=>q[0.98], IO::String=>q[0], File::Temp=>q[0], Test::Fatal=>q[0], Test::Deep=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[6.30] }
#     DISTNAME => q[App-SuperviseMe]
#     EXE_FILES => [q[bin/supervise-me]]
...
O_FILES  = 
H_FILES  = 
MAN1PODS = bin/supervise-me
MAN3PODS = lib/App/SuperviseMe.pm
...
TO_INST_PM = lib/App/SuperviseMe.pm

PM_TO_BLIB = lib/App/SuperviseMe.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  bin/supervise-me $(INST_MAN1DIR)/supervise-me.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/App/SuperviseMe.pm $(INST_MAN3DIR)/App::SuperviseMe.$(MAN3EXT) 
...
EXE_FILES = bin/supervise-me

pure_all :: $(INST_SCRIPT)/supervise-me
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/supervise-me 

$(INST_SCRIPT)/supervise-me : bin/supervise-me $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/supervise-me
	$(CP) bin/supervise-me $(INST_SCRIPT)/supervise-me
	$(FIXIN) $(INST_SCRIPT)/supervise-me
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/supervise-me
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''very simple command superviser'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: App-SuperviseMe' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "very simple command superviser",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "App-SuperviseMe",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>very simple command superviser</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/App/SuperviseMe.pm blib/lib/App/SuperviseMe.pm 
